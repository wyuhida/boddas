...
class AdminBlogController extends Controller
{
    ...
    public function store_admin_blog(Request $request)
    {
        $ids = auth()->user()->id;
    ...
    public function edit_admin_blog($id)
    {
        ...
        return view('admin.blog.edit', ['edit_blog' => $edit_blog]);
    }

    public function update_admin_blog(Request $request, $id)
    {
        $ids = auth()->user()->id;
    ...
    public function detail_admin_blog($id)
    {
        $detail = News::find($id);
        return view('admin.blog.detail', ['detail' => $detail]);
    }
