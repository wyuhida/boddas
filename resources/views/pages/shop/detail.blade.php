...
<section class="py-12 px-12">
  <div class="container grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 mx-auto">
                ...
                items-center justify-center shadow-sm cursor-pointer"
                 ...
                 @if($det->video != null)
                  <iframe 
                    class="w-1/5 h-24 mx-2 mt-2 rounded border-gray-300 inline-block text-center object-center object-cover
                    items-center justify-center shadow-sm cursor-pointer"
                    src="{{asset('video/product')}}/{{$det->video}}" onclick="changes(this.src)"
                 ...
                 @endif
                 {{-- <img
                 class="w-1/5 h-24 mx- mt-2  rounded border-gray-300 inline-block text-center object-center object-cover
                 items-center justify-center"
                  src="{{asset('image/product')}}/{{$det->photo}}" alt="">
                  <img
                class="w-1/5 h-24 mx-2 mt-2 rounded border-gray-300 inline-block text-center object-center object-cover
                items-center justify-center"
                 src="{{asset('image/product')}}/{{$det->photo}}" alt="">
          ...
          <div class="">
            <!-- best seller -->
            <h2 class="text-left mx-4 text-bookmark-white  font-Roboto text-lg">Best Seller</h2>
