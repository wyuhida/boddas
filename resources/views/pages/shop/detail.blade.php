...
<section class="py-12 px-12">
  <div class="container grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 mx-auto">
          <div class="">
              ...
              src={{URL::asset("image/product/{$detail[0]->photo}")}} 
              alt="" id="main">
              ...
              <div class="mx-auto py-3 items-center justify-center">
                ...
                items-center justify-center shadow-sm cursor-pointer"
                 src={{URL::asset("image/product/{$det->photo}")}} alt="" onclick="change(this.src)">
    ...
    <div class="container 
        ...
        <div class="flex flex-col  border-gray-300 h-max hover:border-bg-tombol border-2 shadow-md">
          <div class="items-center mx-auto mt-8 max-h-48">
            ...
            src={{URL::asset("image/product/{$rel_p[0]->photo}")}} alt="">
          </div>
