    ...
    <div class="col-sm-12">
        <div class="ibox">
            <div class="ibox-content">
              ...
              <a type="button" href="{{route('superadmin.show_superadmin_blog')}}" 
              ...
              {{-- <p>
                ...
                {{-- <br> --}}
                <div class="ibox-content">
                    <form class="form-horizontal" action="{{route('superadmin.update_superadmin_blog',$edit_blog->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                name="title" value={{$edit_blog->title}} required 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <img src="{{ asset('image/artikel')}}/{{$edit_blog->thumbnail}}" alt="" style="width: 50%; height:200px;">
                            </div>
                        </div>
