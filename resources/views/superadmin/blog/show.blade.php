        ...
        <div class="ibox">
            <div class="ibox-content">
                ...
                <div class="pull-right">
                  <a type="button" href="{{route('superadmin.create_superadmin_blog')}}" class="btn btn-sm btn-info"><i class="fa fa-plus"></i> Tambah</a> 
                ...
                <br />
                <form action="{{ route('superadmin.show_superadmin_blog')}}" method="GET">
                  ...
                  <table class="table table-hover dataTables-example table-responsive">
                    ...
                    <tbody>
                        ...
                        <td>
                          ...
                          <a href="{{route('superadmin.detail_superadmin_blog', $blog->id)}}">selengkapnya</a>
                          </td>
                        <td>{{$blog->created_at}}</td>
                        <td>
                            <a type="button" href="{{route('superadmin.edit_superadmin_blog',$blog->id)}}"  
                            ...
                            <form id="delete-form-{{$blog->id}}" 
                                action="{{route('superadmin.delete_superadmin_blog',$blog->id)}}" 
