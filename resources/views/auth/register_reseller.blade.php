...
<div class="flex flex-col items-center mt-32 justify-center bg-gray-300 h-screen select-none md:mt-32">
    <div class="flex flex-col  bg-white px-4 sm:px-6 md:px-4 lg:px-5 py-4 rounded-sm shadow-2xl w-full max-w-lg  border-l-4 border-bg-tombol">
        <div class="font-Inter border-b-2 border-bg-tombol self-center w-60 text-center p-2  text-gray-600 text-lg">Daftar Reseller</div>
        <div class="mt-10">
            <form method="POST" action="{{route('register_buyer')}}" autocomplete="">
                @csrf
                <input type="hidden" name="id_buyer" value="2" >
