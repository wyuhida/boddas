        ...
        <div class="ibox">
            <div class="ibox-content">            
              ...
              <h2>Tambah Data Pengenalan Promosi</h2>
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" action="{{route('admin.update_testimoni', $edit_t->id_container)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <img class="img-upload" src="{{asset('image/testimoni')}}/{{$edit_t->image}}"/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                <input type="checkbox" id="publish" class="filled-in"  name="status" value="1"{{ $edit_t->id_content_status == 1 ? 'checked' : ''}}>
