        ...
        <div class="ibox">
            <div class="ibox-content">
              ...
              {{-- <p>
                ...
                {{-- <br> --}}
                <div class="ibox-content">
                    <form class="form-horizontal" action="{{route('admin.update_admin_kategori',$edit->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        {{-- <p>Isi Form.</p> --}}
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                <input type="checkbox" id="publish" class="filled-in" name="status" value="1 "{{ $edit->is_active == true ? 'checked' : ''}}>
