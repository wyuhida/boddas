        ...
        <div class="lg:flex py-9">
            <div class="w-full lg:w-2/5  gap-20">
                <div class="px-6">
                    ...
                    <p class="max-w-md mt-2 text-white">
                      Store & Office
                      Jl. Selalu Merdeka, No. 10-12, Sukabumi, Sukasari, Bogor, Jawa Barat, Indonesia
                    </p>
                </div>
            </div>
                    ...
                    <div class="">
                        ...
                        <div class="block py-1">
                          <span class="w-7 mt-10 text-white ">
                           ...
                           <p class="inline py-9 text-sm text-white font-Poppins">021-11223344</p>
                        </div>
                        ...
                        <div class="block py-1">
                          <span class="w-7 mt-10 ">
                           ...
                           <p class="inline py-9 text-sm text-white font-Poppins">boddas@gmail.com</p>
                        </div>
